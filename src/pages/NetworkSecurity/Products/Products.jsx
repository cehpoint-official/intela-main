...
const Products = () => {
  ...
  return (
    <div className="bg-[#082C6B] py-5">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 md:gap-28 py-5 mx-auto sm:max-w-xl md:max-w-full lg:mx-9 px-10 md:py-10  text-white rounded-2xl shadow-2xl ">
        <div
