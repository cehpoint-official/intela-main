...
const CoreValues = () => {
  return (
    <div className="bg-[#021E4C] text-white py-5">
      <h1 className="text-lg md:text-xl lg:text-2xl font-bold pb-10 text-center py-10 px-4 ml-7 md:px-8 lg:px-20 rounded-md shadow-2xl pt-8">
        OUR CORE VALUES THAT MAKE US PROFESSIONAL
      </h1>

      <div className="px-4 md:px-8 lg:pl-20 lg:pr-16 mx-5 backdrop:sm:max-w-xl md:max-w-full lg:max-w-screen-xl py-10 lg:py-20 bg-[#082C6B] text-white shadow-2xl rounded-2xl">
