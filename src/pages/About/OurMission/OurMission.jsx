...
const OurMission = () => {
  return (
    <div className="bg-[#021E4C] py-5 pt-10 lg:pt-40">
      <div className=" md:px-8 lg:px-20 mx-5 backdrop:sm:max-w-xl md:max-w-full lg:max-w-screen-xl py-10 lg:py-20 bg-[#789ee4] bg-opacity-5 text-white shadow-2xl rounded-2xl">
