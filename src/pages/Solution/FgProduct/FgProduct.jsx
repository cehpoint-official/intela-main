...
const FgProduct = () => {
  ...
  return (
    <div className="bg-[#021D4A] text-white pt-11">
      <h2
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 gap-7 md:gap-5 py-5 mx-auto sm:max-w-xl md:max-w-full lg:mx-9 px-9 md:py-10 rounded-2xl shadow-2xl">
        <div
