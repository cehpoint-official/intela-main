        ...
        <div className="flex flex-col md:flex-row justify-between items-center h-full">
          ...
          <div className="w-full md:w-1/3 text-white text-left mx-4 md:mx-8">
            ...
            <div className={` z-[29] ${toggle ? "" : "hidden"} absolute top-[6rem] left-0 md:left-[20rem]`}>
              <div className="bg-[#072966] shadow-md shadow-slate-400 rounded-2xl m-2 h-[50%] md:w-[60%] md:p-4 p-2">
                <div className="flex justify-end">
                  <button onClick={handleClick}><i class="bi bi-x-lg"></i></button>
                </div>
                <div className="text-center">
                  <p className="text-2xl">E Commerce Website</p>
                  <p className="mt-3">Create a secure and user-friendly e-commerce platform for seamless online shopping experiences.</p>
                </div>
                <div className="border border-dashed mt-2"></div>
                <div>
                  <p className="pt-5 text-xl">E-Commerce Website</p>
                  <p className="mt-4">
                    {viewmore ? (
                      viewmore.map(item => (
                        // Ensure that `item.paragraph1` matches the field name in your Firestore documents
                        <div key={item.id}>
                          <h2>{item.ecommerceviewmore}</h2>
                        </div>
                      ))
                    ) : (
                      <span>Loading...</span>
            ...
            <br />
            {/* discuss */}
            <div className={` z-[29] ${quotation ? "" : "hidden"} m-2 left-0 absolute top-[110rem] md:top-[79rem] md:left-[40%] flex justify-center items-center`}>
