...
const WdFeature4 = () => {
  ...
  return (
    <div className="bg-[#011C49] pt-10 z-[30]">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center h-full">
          ...
          <div className="w-full md:w-1/3 text-white text-left mx-4 md:mx-8">
            ...
            >
              ...
              {/* A portfolio website is a digital platform where individuals or businesses showcase their work, achievements, and skills to potential clients or employers. It serves as an online portfolio to highlight past projects, expertise, and capabilities.... */}
            </p>
            <button onClick={e => {
              e.stopPropagation()
              setToggle(!toggle)
            ...
            {/* pop-up start */}
            <div className={` z-[29] ${toggle ? "" : "hidden"} absolute top-[6rem] left-0 md:left-[5rem] flex justify-center items-center`}>
              <div className="bg-[#072966] shadow-md shadow-slate-400 rounded-2xl h-[50%] md:w-[60%] md:p-4 p-2">
                ...
                <div className="text-center">
                  ...
                  <p className="mt-3">Craft a visually compelling portfolio website to showcase your work and skills effectively.</p>
                </div>
                <div className="border border-dashed mt-2"></div>
                <div>
                  <p className="pt-5 text-xl">Portfolio Website</p>
                  <p className="mt-3">
            ...
            <br />
            {/* discuss */}
            <div className={` z-[29] ${quotation ? "" : "hidden"} m-2 left-0 absolute top-[10rem] md:top-[10rem] md:left-[40%] flex justify-center items-center`}>
