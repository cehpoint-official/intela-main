...
const WdFeature3 = () => {
  ...
  return (
    <div className="bg-[#011C49] pt-10">
      <div className="relative bg-[#072966] z-[0] mx-4 md:mx-8 lg:mx-20 rounded-2xl">
        <div className="flex flex-col md:flex-row justify-between items-center h-full">
          ...
          <div className="w-full md:w-1/3 text-white text-left mx-4 md:mx-8">
            <h2 className="text-xl md:text-2xl lg:text-3xl mx-4 mb-3 md:mb-5">
              WordPress Website
            </h2>
            <p
            ...
            >
              ...
              {/* A WordPress website is a website created using the WordPress content management system (CMS), which allows users to easily create, manage, and update content without needing extensive technical knowledge..... */}
            </p>
            <button onClick={e => {
              e.stopPropagation()
              setToggle(!toggle)
            }} className="text-[#BD981B] py-5 underline mx-4" href="">
              View More
            </button>
            {/* pop-up start */}
            <div className={` z-[29] ${toggle ? "" : "hidden"} absolute top-[6rem] left-0 md:left-[20rem]`}>
              <div className="bg-[#072966] shadow-md shadow-slate-400 rounded-2xl h-[50%] md:w-[60%] md:p-4 p-2 m-2">
                ...
                <div className="text-center">
                  <p className="text-2xl">WordPress Website</p>
                  <p className="mt-3">Design and develop a WordPress website with customizable themes, plugins, and responsive design for a versatile and user-friendly online presence.</p>
                </div>
                <div className="border border-dashed mt-2"></div>
                <div>
                  <p className="pt-5 text-xl">WordPress Website</p>
                  <p className="mt-4">
            ...
            <br />
            {/* discuss */}
            <div className={` z-[29] ${quotation ? "" : "hidden"} m-2 left-0 absolute top-[20rem] d:mtop-[13rem] md:left-[40%] flex justify-center items-center`}>
